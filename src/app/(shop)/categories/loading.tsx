      ...
      <div className="w-full bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
        <div className="container mx-auto px-4 py-10">
          <div className="animate-pulse flex flex-col items-center gap-4">
            ...
            <div className="h-8 w-56 rounded-xl bg-slate-200 dark:bg-slate-800/50" />
            <div className="h-4 w-80 max-w-full rounded-lg bg-slate-200 dark:bg-slate-800/50" />
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="animate-pulse flex flex-col gap-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="h-8 w-52 rounded-xl bg-slate-200 dark:bg-slate-800/50" />
